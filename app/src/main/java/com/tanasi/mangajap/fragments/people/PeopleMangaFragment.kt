...
class PeopleMangaFragment : Fragment() {
            ...
            viewModel.state.flowWithLifecycle(lifecycle, Lifecycle.State.STARTED).collect { state ->
                when (state) {
                    ...
                    is PeopleViewModel.State.SuccessLoading -> {
                        displayPeopleManga(state.people.mangaStaff)
    ...
    private fun initializePeopleManga() {
    ...
    private fun displayPeopleManga(staff: List<Staff>) {
